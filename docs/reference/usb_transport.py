"""
Reference: cdump/radiacode USB transport layer
Source: https://github.com/cdump/radiacode/blob/main/src/radiacode/transports/usb.py

This is the Python USB transport for RadiaCode devices.
Saved here as reference for Phase 4 (ESP32 USB Host mode).

Key protocol details:
- VID: 0x0483 (STMicroelectronics)
- PID: 0xF123
- Write endpoint: 0x01 (OUT)
- Read endpoint:  0x81 (IN)
- Max packet size: 256 bytes
- Response format: 4-byte little-endian length prefix, then payload
- Device drains any pending data on init (reads until timeout)
"""
